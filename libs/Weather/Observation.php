...
final class Observation
{
    ...
    public const QUANTITIES = [
        ...
        'etMonthMm'      => ['Verdunstung Monat', 'mm', '~Rainfall'],
        'etYearMm'       => ['Verdunstung Jahr', 'mm', '~Rainfall'],
        'rainLastMm'     => ['Letzter Regen', 'mm', '~Rainfall'],
        'forecastCode'   => ['Vorhersage (Stationscode)', '', ''],
        'strikeTime'     => ['Letzter Blitz', '', '~UnixTimestamp'],
        'strikeDistKm'   => ['Blitzentfernung', 'km', 'WX.km'],
        'strikeCount'    => ['Blitze', '', ''],
